...
def fpg():
    ...
    pcls.grid(row=3,column=1,pady=2)
    


    framelde = Frame(frameLdd,width=300,height=200,bg='MediumPurple1',bd= 10,relief=RIDGE)
    ...
    txtReceipt  = Text(framelde1,height=20,width=30,bd=24,font="arial 9 bold")
    txtReceipt.grid(row=0,column=0)

    framelde2 = Frame(frameLdd,width=300,height=200,bg='MediumPurple1',bd= 10,relief=RIDGE)
